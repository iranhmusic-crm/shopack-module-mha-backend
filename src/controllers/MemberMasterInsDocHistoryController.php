...
use iranhmusic\shopack\mha\backend\models\MemberMasterInsDocHistoryModel;

class MemberMasterInsDocHistoryController extends BaseRestController
{
	...
	// {
	// 	if (($model = MemberMasterInsDocHistoryModel::findOne([
	// 				'mbrminsdochstID' => $id,
	// 			])) !== null)
	// 		return $model;
	...
	public function actionCreate()
	{
		...
		$model = new MemberMasterInsDocHistoryModel();
		...
		return [
			// 'result' => [
				// 'message' => 'created',
				'mbrminsdochstID' => $model->mbrminsdochstID,
				'mbrminsdochstAction' => $model->mbrminsdochstAction,
				'mbrminsdochstCreatedAt' => $model->mbrminsdochstCreatedAt,
				'mbrminsdochstCreatedBy' => $model->mbrminsdochstCreatedBy,
			// ],
		];
	}
